        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateofEstablishment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MerchantNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AverageTransactionVolume = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
